...
class YiFeiReplayGUI:
    ...
    def _load_game_records(self):
        ...
        # 查找所有JSON和.data文件（默认路径 game_records_v8）
        json_files = list(Path("game_records_v8").glob("*.json"))
        data_files = list(Path("game_records_v8").glob("*.data"))
