...
start "yf1_v5 (0号位)" cmd /k "cd /d %REPO_ROOT% && python src/communication/yf1_v5.py"
echo   等待 3 秒...
...
start "lalala_client3 (1号位)" cmd /k "cd /d %REPO_ROOT% && python src/communication/run_lalala_client3.py"
echo   等待 3 秒...
timeout /t 3 /nobreak > nul
echo.
...
start "yf2_v5 (2号位)" cmd /k "cd /d %REPO_ROOT% && python src/communication/yf2_v5.py"
echo   等待 3 秒...
timeout /t 3 /nobreak > nul
echo.
...
start "lalala_client4 (3号位)" cmd /k "cd /d %REPO_ROOT% && python src/communication/run_lalala_client4.py"
echo.
