...
> 维护者：yifeGDBOT 团队 | 分支：`m-dev`（原 `m1-dev`）
>
> **存放**：`docs/development/M1_ARCHITECTURE.md`（自 commit `8742946` 恢复，2026-06-01）。
> 正文中的 `src/decision/` 经 shim 指向现行代码 **`src/m/m1/`**；M1 已 **frozen**（GUA-022），队胜率 KPI 看 M3。
