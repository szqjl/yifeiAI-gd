...
> **当前活跃**：**GUA-064** 🔴 — BC argmax collapse；**GUA-065** 🟡 — 队友保护已实施+批跑，副胜率+18.5pp但局级仍0；**GUA-068** 🟢 — R11 全局抑制牌检查+节流已实施，待批跑；**GUA-054** — 动作空间过滤（须先解 GUA-064）；**GUA-059** — 退化为观测；**GUA-062** ✅ / **GUA-063** ✅
