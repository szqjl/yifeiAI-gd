...
> **当前活跃**：**GUA-064** 🔴 — BC argmax collapse；**决议6-10** 🟡 — 已实施但批跑显示副胜率下降(25.5%→10.5%)，需排查过滤是否过严；**GUA-068** 🟢 — R11 全局抑制牌检查+节流已实施待批跑；**GUA-069** 🟢 — 超弱角色core保护已修复待批跑；**GUA-070** 🟢 — R12拆对子出单禁制已实施待批跑；**GUA-054** — 动作空间过滤（须先解 GUA-064）；**GUA-059** — 退化为观测；**GUA-062** ✅ 组牌 v2 / **GUA-063** ✅ 衔接
