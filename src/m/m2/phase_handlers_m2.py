...
from m.m1.stage_router import BasePhaseHandler
from decision.card_power_evaluator import calculate_card_power
from decision.optimal_combination_scanner import OptimalCombinationScanner, find_excess_singles_for_passive_play
...
class M2OpeningActiveHandler(BasePhaseHandler):
    ...
    def _init_strategy_engine(self):
        ...
        try:
            from m.m1.hand_structure_analyzer import HandStructureAnalyzer
            from decision.optimal_combination_scanner import OptimalCombinationScanner
            from decision.card_power_evaluator import calculate_card_power
