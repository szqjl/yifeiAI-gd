# -*- coding: utf-8 -*-
# 涓绛夊栦唬鐮 - client3
# 閫傞厤绂荤嚎骞冲彴锛堢鍙23456锛孶RL鏍煎紡/game/client3锛
...
class FirstPrizeClient3(WebSocketClient):
    ...
    def opened(self):
        print("[client3] Connected successfully!")

    def closed(self, code, reason=None):
        print(f"[client3] Closed down: {code}, {reason}")
        ...
        try:
            ...
            if "actionList" in message:
                try:
                    ...
                    print(f"[client3] Act index: {act_index}")
...
if __name__ == '__main__':
    try:
        # 绂荤嚎骞冲彴閰嶇疆锛堢鍙23456锛孶RL鏍煎紡/game/client3锛
        ws = FirstPrizeClient3('ws://127.0.0.1:23456/game/client3')
        ws.connect()
        ws.run_forever()
    except KeyboardInterrupt:
        ws.close()
    except Exception as e:
        print(f"[client3] Connection error: {e}")
